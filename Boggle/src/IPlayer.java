 ...
 * computer player method. (See <code>IAutoPlayer</code>).
 *
...
public interface IPlayer extends Iterable<String>
{
    ...
    /**
     * Get the score for this player, see <code>BoggleScore</code> for how
    ...
    /**
     * Add a word for the player. The player may choose to ignore duplicate
     * words, skip words not in the lexicon, or to check these.
     * 
     * @param word
     * @return TODO
