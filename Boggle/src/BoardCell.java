...
public class BoardCell implements Comparable<BoardCell>
{
    ...
    /**
     * BoardCell constructor that is created by designating a cell with a row
     * and column.
     * 
     * @param r
     * @param c
    ...
    /**
     * Compares two board cells by their rows and columns.
     */
    ...
    /**
     * Returns the hash for the board cell.
     */
    public int hashCode()
    {
        return hash;
