...
/**
 * Simple Lexicon implementation simply storing words in a set. This makes
 * finding WORD status fast, but PREFIX requires iterating over all the strings
 * stored.
 * 
...
public class SimpleLexicon implements ILexicon
{
    ...
    public LexStatus wordStatus( String s )
    {
        ...
        if ( wordAfter != null && wordAfter.startsWith( s ) )
