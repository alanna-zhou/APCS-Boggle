...
public class BoggleGUI extends JFrame
{
    ...
    public void computerPlay()
    {
        ...
        {
            computerArea.showWord( s,
                myFinder.cellsForWord( myBoard, s ),
                computerPlayer );
        }
    ...
    private class BoggleBoardPanel extends JPanel
    {
        ...
        BoggleBoardPanel( int rows, int cols )
        {
            ...
            innerPanel.setBorder( BorderFactory.createMatteBorder( 10,
                10,
                10,
                10,
                BACKGROUNDCOLOR ) );
        ...
        private class DiePanel extends JPanel
        {
            ...
            private final Font FACEFONT = new Font( "SansSerif",
                Font.PLAIN,
                24 );
        ...
        public WordEntryField()
        {
            ...
            textField.addActionListener( new ActionListener()
            {
                public void actionPerformed( ActionEvent e )
                {
                    ...
                    if ( s.length() < 3 )
                    {
                        BoggleGUI.this.showError(
                            "Please enter a word with 3 or more letters" );

                    }
                    else if ( myLexicon.wordStatus( s ) != LexStatus.WORD )
                    {
                    ...
                    else
                    {
                        ...
                        {
                            myString.append(
                                myBoard.getFace( cell.row, cell.col ) );
                        }
                        ...
                        {
                            if ( humanPlayer
                                .add( textField.getText().toLowerCase() ) )
                            {
